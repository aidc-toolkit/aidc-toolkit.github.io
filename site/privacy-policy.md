...
Because no personal data is collected or stored, there is no risk of personal data being accessed, shared, or breached through the application.

Étant donné qu’aucune donnée personnelle n’est collectée ou stockée, il n’existe aucun risque que des données personnelles soient consultées, partagées ou compromises via l’application.

## Changes to This Privacy Policy / Modifications de la présente politique

This Privacy Policy may be updated from time to time. Any changes will be posted with an updated effective date.

La présente politique de confidentialité peut être mise à jour de temps à autre. Toute modification sera publiée avec une date d’entrée en vigueur mise à jour.
